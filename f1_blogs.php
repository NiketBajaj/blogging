        ...
        <div class="row row-offcanvas row-offcanvas-right">
        	<div class="col-xs-12 col-sm-9">
                ...
                <?php
					...
					$query = "SELECT * FROM blog_blogs WHERE category = 'f1visa' ORDER BY blogs_time DESC;"; // Retrieve the data from the table blog_blogs.
            ...
            <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
                <div class="list-group">
                    <a href="f1_blogs.php" class="list-group-item active">F1 Visa</a>
