...
<html lang="en">
  <head>
    <!-- Comment header
    File name : Your Blog page
    Author's Name : Niket Bajaj
    Web site name : NB Blogging
    On this page user after login can see there old blogs -->
    <meta charset="utf-8">
        ...
        <div class="row row-offcanvas row-offcanvas-right">
        	<div class="col-xs-12 col-sm-9">
                ...
                <?php
					...
					$query1 = $_GET['view'];
					$query = "SELECT * FROM blog_blogs WHERE user_name = '$query1' ORDER BY blogs_time DESC;"; // Retrieve the data from the table blog_blogs.
