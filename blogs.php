...
<html lang="en">
  <head>
  <!-- Comment header
        File name : Blogs page
        Author's Name : Niket Bajaj
        Web site name : NB Blogging
        All blogs are listed here with timing  -->
    <meta charset="utf-8">
        ...
        <div class="row row-offcanvas row-offcanvas-right">
        	<div class="col-xs-12 col-sm-9">
                <p class="pull-right visible-xs">
                	<button type="button" class="btn btn-primary btn-xs" data-toggle="offcanvas">Toggle nav</button> <br /><br />
                </p>
                <?php
					...
					$query = "SELECT * FROM blog_blogs ORDER BY blogs_time DESC;"; // Retrieve the data from the table blog_blogs.
            ...
            <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
                ...
                <img src="img/new_blog.jpg" alt="NB blog" width="225" height="200">
